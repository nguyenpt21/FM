...
from data_loader import DataLoaderFM
...
def train(args):
    ...
    # load data
    data = DataLoaderFM(args, logging)
    ...
    model = FM(args, data.n_users, data.n_items, data.n_entities, data.n_user_attr, user_pre_embed, item_pre_embed)
...
def predict(args):
    ...
    # load model
    model = FM(args, data.n_users, data.n_items, data.n_entities, data.n_user_attr)
